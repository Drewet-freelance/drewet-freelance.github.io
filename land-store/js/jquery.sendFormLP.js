/*-----------------------------------------------	
	   jquery.sendFormLP.js от Сергея Белоусова
-------------------------------------------------*/	
...
;(function($){
  	...
  	jQuery.fn.sendFormLP = function(options){
  		...
  		options = $.extend({
            toEmail: 'drewet00@gmail.com',
            fromEmail: 'drewet@drewet.zzz.com.ua',
            interval : 5000
        }, options);
...
$(function(){
	...
	$('form').sendFormLP({
		toEmail: 'drewet00@gmail.com',
		fromEmail: 'drewet@drewet.zzz.com.ua',
					// сообщение об успешной отправке исчезает через 10 секунд
		interval: 7000
	});
